...
<div class="widget">
            ...
            <div class="widgetcontent">
                ...
                <form class="stdform" action="/index.php/project/adddo" method="post">
                        <p>
                            <label>项目名称</label>
                        ...
                        <p>
                            <label>详细描述</label>
                            <span class="field"><textarea id="project_detail" name="project_detail" cols="500" rows="5" class="input-xxlarge" placeholder="请详细描述项目的立项目的，项目的周期，项目的负责人情况，及其他相关项目信息."><?php echo set_value('project_detail'); ?></textarea></span> 
                        </p>
                        <p class="stdformbutton">
                            <button class="btn alertboxbutton">提交 Submit</button>
