...
<div class="widget">
            ...
            <div class="widgetcontent">
                ...
                <form class="stdform" action="<?php  echo base_url();?>request/addsave/<?php echo $mid;?>" method="post">
						<p>
                            <label>需求名称</label>
		                ...
		                <p>
	                        <div class="par">
	                            ...
	                            <span class="field"><input id="datepicker" type="text" name="enddate" class="input-small" /> 逾期本原始需求将自动关闭 </span>
	                        </div> 
                        </p>
                        
						<p>
                            <label>标价</label>
                            <span class="field"><input type="text" name="price" value="<?php echo set_value('price');?>" class="input-xxlarge" placeholder="此价格影响后续的乙方投标行为，请输入整数" /><a href="http://item.taobao.com/item.htm?id=42643553095" target="_blank"> 付款 </a></span>
                        </p>
                        <p>
                            <label>状态</label>
                            <span class="field">
