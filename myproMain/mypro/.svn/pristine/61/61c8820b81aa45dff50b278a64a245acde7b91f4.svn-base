<?php $this->load->view('pageheader');?> 
    <div class="rightpanel">
		...
		<a class="btn" href="<?php echo base_url();?>request/add/<?php echo $mid;?>"><span class="icon-plus"></span>新增原始需求 Add</a>
		...
		<h4 class="widgettitle"><?=$title?></h4>
			...
			<?php foreach ($query as $key=>$value):?>
                        <tr>
							...
							<td class="center"><a href="<?=base_url()?>request/uploadfiles/<?=$value['id']?>">文件管理</a></td>
                        </tr>
			<?php endforeach;?>
                    </tbody>
                </table>
