		...
		<h4 class="widgettitle"><?=$title?></h4>
            	<table class="table table-bordered responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="center">开放状态</th>
                            <th class="center">模块</th>
                            <th class="center">总体设计</th>
                        </tr>
                    </thead>
                    <tbody>
			<?php foreach ($query as $key=>$value):?>
                        <tr>
                            ...
                            <td><a href="<?=base_url()?>project/detail/<?=$value['id']?>"><?php echo html_escape($value['title']); ?></a></td>
                            <td class="center"><?php echo html_escape($value['budget']); ?></td>
                            <td class="center"><?php echo html_escape($value['city']); ?></td>
                            <td class="center"><?php echo html_escape($value['realName']); ?></td>
                            <td class="center"><?php echo html_escape($value['createDatetime']); ?></td>
                            <td class="center"><?php echo html_escape($value['isopen']); ?></td>
                            <td class="center"><a href="<?=base_url()?>modules/modlst/<?=$value['id']?>">模块<?php if ($title=="我的项目") echo "维护";?></a></td>
                            <td class="center"><a href="<?=base_url()?>wholedesign/lstbypid/<?=$value['id']?>">总体设计</a></td>
