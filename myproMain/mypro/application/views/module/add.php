...
<div class="widget">
            ...
            <div class="widgetcontent">
                ...
                <form class="stdform" action="<?php echo base_url();?>modules/addsave/<?php echo $pid;?>" method="post">
						<p>
                            <label>模块名称</label>
                            <span class="field"><input type="text" name="module_name" value="" class="input-xxlarge" placeholder="请输入，最多５０个汉字" /></span>
                        </p>
                        <p>
                            <label>模块描述</label>
                            <span class="field"><textarea id="content" name="content" cols="500" rows="5" class="input-xxlarge" placeholder="请详细描述模块信息."></textarea></span> 
                        </p>
